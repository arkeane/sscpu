...
* @returns {any}
*/
export function cpu_run(program, data) {
    const ptr0 = passArray16ToWasm0(program, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray16ToWasm0(data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.cpu_run(ptr0, len0, ptr1, len1);
...
* @returns {any}
*/
export function cpu_init_for_step(program, data) {
    const ptr0 = passArray16ToWasm0(program, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray16ToWasm0(data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.cpu_init_for_step(ptr0, len0, ptr1, len1);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function cpu_run_step(jscpu) {
    const ret = wasm.cpu_run_step(addHeapObject(jscpu));
    return takeObject(ret);
}
...
function getImports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_1c54df100599e9eb = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_log_c47cbb19579860b1 = function(arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sscpu_bg.wasm', import.meta.url);
    }
    const imports = getImports();
