...
* @returns {any}
*/
export function run_full(program, data) {
    ...
    const ret = wasm.run_full(ptr0, len0, ptr1, len1);
...
* @returns {any}
*/
export function init_state(program, data) {
    const ptr0 = passArray16ToWasm0(program, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray16ToWasm0(data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.init_state(ptr0, len0, ptr1, len1);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function run_step(jscpu) {
    const ret = wasm.run_step(addHeapObject(jscpu));
    return takeObject(ret);
}
